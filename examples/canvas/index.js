...
template.innerHTML = `
  ...
  <img id="myImg" hidden src="/examples/canvas/december-holidays-days-2-30-6753651837108830.3-law.png">
...
existingCanvasBtn.addEventListener('click', () => {
  // Scenario #1:
...
doubleCanvasBtn.addEventListener('click', () => {
  // Scenario #3:
